...
if __name__ == "__main__":
    ...
    if args.phase == "PolicyTraining":
        ...
        for iteration in range(1, args.num_iterations + 1):
            ...
            # Rollout (trajectory) data collection
            ...
            for step in range(0, args.num_steps):
                ...
                # TRY NOT TO MODIFY: execute actions in the environment and log data.
            ...
            # Optimizing the policy and value network using collected data
            agent.train()
            ...
            # Track progress, log metrics, and save intermediate models
    ...
    elif args.phase == "AdaptationTraining":
        pass
    
    else:
        assert args.phase == "Evaluation"
        pass